...
export default function ProfilePage() {
  ...
  console.log("Current Plan:", currentPlan,subscription,availablePlans);
  ...
  >({
    ...
    onSuccess: () => {
      ...
      refetch(); // Refetch subscription details after changing plan
    },
    onError: (error) => {
    ...
    <div className="min-h-screen flex items-center justify-center bg-blue-100 p-4">
      ...
      <div className="w-full max-w-5xl bg-white shadow-lg rounded-lg overflow-hidden">
        <div className="flex flex-col md:flex-row">
          ...
          <div className="w-full md:w-1/3 p-6 bg-blue-500 text-white flex flex-col items-center">
            <Image
          ...
          <div className="w-full md:w-2/3 p-6 bg-gray-50">
            ...
            {isLoading ? (
              ...
              <div className="space-y-6">
                ...
                <div className="bg-white shadow-md rounded-lg p-4 border border-blue-200 text-black">
                ...
                <div className="bg-white shadow-md rounded-lg p-4 border border-blue-200">
                  ...
                  <button
                    ...
                    className="mt-3 p-2 bg-blue-500 rounded-lg text-white"
                  >
                    Save Change
                  </button>
